...
export class Master_Ncb implements IMaster_Ncb, IMaster_NcbMethod {
  ...
  static builder: SqlBuilder = new SqlBuilder(
    ...
    icon_reference_ndid: { name: "IconReferenceNdid", type: sql.NVarChar, is_identity: false, is_primary: false },
    ...
    ["id"],
    ["id","ncb_id","is_ncb","is_ncb_terms","ncb_status_code","ncb_type","ncb_count","bank_code", "bank_mode", "reference_id","ndid_request_id","ndid_response","customer_id","booking_no","contract_id","contract_no","project_code","project_name","unit_id","create_date","update_date","ncb_date_of_expiry","ndid_reference","icon_reference_ndid","request_params","is_credit_out"]
  );
  ...
  loadByData(data: IMaster_Ncb): void {
    ...
    this.icon_reference_ndid = data.icon_reference_ndid;
  ...
  insert(request: Request): Promise<string | number> {
    return Master_Ncb.insert(request, {
      ...
      icon_reference_ndid: this.icon_reference_ndid,
